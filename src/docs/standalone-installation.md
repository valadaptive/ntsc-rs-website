...
Prebuilt binaries are currently not available for macOS. You'll need to build the application yourself following [these instructions on GitHub](https://github.com/valadaptive/ntsc-rs/issues/36#issuecomment-1953132373).
